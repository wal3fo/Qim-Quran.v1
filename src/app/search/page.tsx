    ...
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-8 px-4 py-12 sm:px-6">
      ...
      <div className={`grid gap-3 ${advanced ? "sm:grid-cols-[2fr_1fr]" : "sm:grid-cols-1"}`}>
        <input
          ...
          className="rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-primary-500 dark:border-zinc-800 dark:bg-black"
        />
        {advanced && (
          <select
            {...register("surah")}
